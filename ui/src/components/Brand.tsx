/* The mark: a solid badge with a layout knocked out of it — a sidebar, a filled
   block, and one accent block. The accent is the piece the agent draws, which is
   the product in a glyph. Knockout rather than outline, so it holds at 20px. */
export function Mark({ size = 38 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 38 38" fill="none" aria-label="GenUI Kit">
